package hr.mlinx.core.processor;

import hr.mlinx.core.data.Player;
import hr.mlinx.core.data.Team;
import hr.mlinx.core.data.calculation.controller.CombinationController;
import hr.mlinx.core.data.calculation.manager.TopCombinationManager;
import hr.mlinx.core.data.calculation.manager.TopCombinationManagerByAdditional;
import hr.mlinx.core.data.calculation.manager.TopCombinationManagerByForm;
import hr.mlinx.core.data.calculation.manager.TopCombinationManagerByTotalPoints;
import hr.mlinx.core.data.calculation.strategy.combination.*;
import hr.mlinx.core.io.csv.CSVGenerator;
